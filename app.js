...
const DOMS = [
  ...
  { id: 'ar', n: '往来对账', ic: '◫', items: [
      ['p-rec-src', '数据源导入'], ['p-rec-ar', '应收账单'], ['p-rec-ap', '应付账单'],
      ['p-rec-hx', '应收及应付核销'], ['p-rec-aging', '账龄与催收'], ['p-rec-dash', '往来对账看板']] },
  { id: 'cost', n: '流程审批', ic: '▧', items: [['p-exp', '报销与费控'], ['p-flow', '审批路由']] },
...
const PHASE2 = {
  ...
  'p-rec-src': ['数据源导入', 'M3', '应收/应付台账与对方对账单导入，统一进往来数据池'],
  'p-rec-ar': ['应收账单', 'M3', '按客户/合同生成与跟踪应收'],
  'p-rec-ap': ['应付账单', 'M3', '按供应商跟踪应付与付款计划'],
  'p-rec-hx': ['应收及应付核销', 'M3', '收付款与账单逐笔勾对核销'],
  'p-rec-aging': ['账龄与催收', 'M3', '四级逾期分级预警'],
  'p-rec-dash': ['往来对账看板', 'M3', '应收应付总览、核销进度与差异一屏看清'],
